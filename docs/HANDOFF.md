...
| M12 unsigned Beta + 当前源码更新服务 | VERIFIED（Beta 已发布，源码前进） | `docs/TEST_REPORT.md`、ADR-0043/0048；signed Stable qualification BLOCKED |
